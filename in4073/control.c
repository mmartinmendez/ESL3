...
void panic_mode (bool second_run)
{
...
void manual_mode ()
{
	...
	if(liftdata == -127) {
		...
		updated[0] = (liftdata + pitchdata / 2 - yawdata + 127 * 2 * 2 / 3) * 2;
		updated[1] = (liftdata - rolldata / 2 + yawdata + 127 * 2 * 2 / 3) * 2;
		updated[2] = (liftdata - pitchdata / 2 - yawdata + 127 * 2 * 2 / 3) * 2;
		updated[3] = (liftdata + rolldata / 2 + yawdata + 127 * 2 * 2 / 3) * 2;
...
// Author: B.T. Blokland
void run_filters_and_control (bool * demo_done, bool second_run)
{
